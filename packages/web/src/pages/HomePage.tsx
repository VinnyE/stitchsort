...
export default function HomePage() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 z-10 text-center lg:text-left">
            ...
            <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl text-on-surface leading-[1.1] tracking-tight mb-8">
              ...
              <span className="italic text-primary lg:text-inherit">
                right for you?
              </span>
            </h1>
            <p className="font-body text-lg md:text-xl text-on-surface-variant max-w-xl mb-12 leading-relaxed mx-auto lg:mx-0">
              Stop guessing. Start sewing. Find your machine in 90 seconds with
              our independent matching engine.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-surface-container-highest md:bg-transparent flex items-center justify-center text-primary">
      ...
      {/* Thread Divider (mobile) */}
      <div className="md:hidden py-12 flex justify-center items-center gap-2 overflow-hidden">
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          {[
            ...
            <div key={step.icon} className="relative z-10 group">
